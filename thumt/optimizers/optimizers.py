...
class AdamOptimizer(Optimizer):
    ...
    def __init__(self, learning_rate=0.01, special_learning_rate=0.01, special_var_name="None", beta_1=0.9, beta_2=0.999,
                 epsilon=1e-7, name="Adam", **kwargs):
        super(AdamOptimizer, self).__init__(name, **kwargs)
        self._learning_rate = learning_rate
        self._special_learning_rate = special_learning_rate
        self._special_var_name = special_var_name
        self._beta_1 = beta_1
        self._beta_2 = beta_2
    ...
    def apply_gradients(self, grads_and_vars):
        ...
        for grad, var in zip(grads, var_list):
            ...
            if self._special_var_name in name:
                lr = self._special_learning_rate
            else:
                lr = self._learning_rate
